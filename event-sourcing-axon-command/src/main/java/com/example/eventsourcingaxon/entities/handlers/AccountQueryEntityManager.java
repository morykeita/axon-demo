package com.example.eventsourcingaxon.entities.handlers;

import com.example.eventsourcingaxon.aggreagtes.AccountAggregate;
import com.example.eventsourcingaxon.entities.AccountQueryEntity;
import com.example.eventsourcingaxon.entities.repositories.AccountRepository;
import com.example.eventsourcingaxon.events.BaseEvent;
...
public class AccountQueryEntityManager {
    ...
    @Autowired
    @Qualifier(value = "accountAggregateEventSourcingRepository")
